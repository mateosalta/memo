...
Page {
    ...
    property alias bottomEdgeIconName: tipIcon.name
    property alias bottomEdgeIconSource: tipIcon.source
    property alias bottomEdgeColor: tip.color
    ...
    UbuntuShape {
        ...
        Label {
            ...
            //color: ColorUtils.luminance(tip.color) >= 0.85 ? UbuntuColors.darkGrey : "#FFFFFF"
            visible: text
        ...
        Icon {
            ...
            height: bottomEdge.tipHeight - units.gu(0.5)
