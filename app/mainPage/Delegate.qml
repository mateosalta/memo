    ...
    UbuntuShape {
        ...
        Column {
                        ...
                        Image {
                            ...
                            Component.onCompleted: calculateSize(index)
                             ...
                             function calculateSize(index) {
                                ...
                                var picFlowRealWidth = ((root.width - units.gu(4)) * 0.5) - units.gu(1)
            ...
            Loader {
                id: listLoader
                width: parent.width
                sourceComponent: (contents.list[0]) ? listComponent : null
                ...
                Component {
                    ...
                    Column {
                        ...
                        Component.onCompleted: listRepeater.model = contents.list
                    }
                }
            }
